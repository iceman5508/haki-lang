...
typedef struct typeck__FnInfo typeck__FnInfo;
typedef struct typeck__SymTable typeck__SymTable;
typedef struct mono__MonoFn mono__MonoFn;
typedef struct mono__MonoProgram mono__MonoProgram;
typedef struct tinfer__TypedExpr tinfer__TypedExpr;
typedef struct tinfer__TypedStmt tinfer__TypedStmt;
typedef struct tinfer__Scope tinfer__Scope;
...
typedef struct { int64_t tag; void* payload; } typeck__SemTy;
...
struct typeck__FnInfo {
    const char* name;
    typeck__SemTy* retTy;
    int64_t nParams;
};

struct typeck__SymTable {
    void* fns;
    void* structs;
    void* errors;
};
...
struct tinfer__TypedExpr {
    compiler__Expr* kind;
    const char* ty;
};

struct tinfer__TypedStmt {
    compiler__Stmt* kind;
    const char* declTy;
};

struct tinfer__Scope {
    void* names;
    void* types;
};
...
const char* cemit__emitStmt(compiler__Stmt* stmt, int64_t depth, tinfer__Scope* sc, typeck__SymTable* sym);
...
const char* cemit__emitFn(mono__MonoFn* f, typeck__SymTable* sym);
...
const char* cemit__cTy(const char* ty) {
    ...
    return haki_string_concat(cemit__cName(ty), "*");
}
...
const char* cemit__emitExpr(compiler__Expr* e, int64_t depth, tinfer__Scope* sc, typeck__SymTable* sym) {
    ...
    if ((strcmp(tag, "string") == 0)) {
        ...
        return haki_string_concat(haki_string_concat("\"", cemit__escapeStr(s)), "\"");
    }
    if ((strcmp(tag, "ident") == 0)) {
        const char* n = ({ const char* __match_result;  void* __msc = (void*)e;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 4LL) { const char* n = *(const char**)__mpayload; __match_result = n; } else { __match_result = ""; } __match_result; });
        return cemit__cName(n);
    }
    if ((strcmp(tag, "unary") == 0)) {
        const char* op = ({ const char* __match_result;  void* __msc = (void*)e;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 5LL) { const char* op = *(const char**)((void**)__mpayload)[0]; compiler__Expr* inner = *(compiler__Expr**)((void**)__mpayload)[1]; __match_result = op; } else { __match_result = ""; } __match_result; });
        compiler__Expr* inner = ({ compiler__Expr* __match_result;  void* __msc = (void*)e;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 5LL) { const char* op = *(const char**)((void**)__mpayload)[0]; compiler__Expr* inner = *(compiler__Expr**)((void**)__mpayload)[1]; __match_result = inner; } else { __match_result = compiler__nullExpr(); } __match_result; });
        return haki_string_concat(haki_string_concat(haki_string_concat("(", op), cemit__emitExpr(inner, depth, sc, sym)), ")");
    }
    if ((strcmp(tag, "binary") == 0)) {
        const char* op = ({ const char* __match_result;  void* __msc = (void*)e;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 6LL) { const char* op = *(const char**)((void**)__mpayload)[0]; compiler__Expr* l = *(compiler__Expr**)((void**)__mpayload)[1]; compiler__Expr* r = *(compiler__Expr**)((void**)__mpayload)[2]; __match_result = op; } else { __match_result = ""; } __match_result; });
        ...
        const char* le = cemit__emitExpr(lExpr, depth, sc, sym);
        const char* re = cemit__emitExpr(rExpr, depth, sc, sym);
    ...
    if ((strcmp(tag, "call") == 0)) {
        ...
        return cemit__emitCall(n, args, depth, sc, sym);
    }
    if ((strcmp(tag, "field") == 0)) {
        compiler__Expr* recv = ({ compiler__Expr* __match_result;  void* __msc = (void*)e;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 8LL) { compiler__Expr* recv = *(compiler__Expr**)((void**)__mpayload)[0]; const char* f = *(const char**)((void**)__mpayload)[1]; __match_result = recv; } else { __match_result = compiler__nullExpr(); } __match_result; });
        const char* f = ({ const char* __match_result;  void* __msc = (void*)e;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 8LL) { compiler__Expr* recv = *(compiler__Expr**)((void**)__mpayload)[0]; const char* f = *(const char**)((void**)__mpayload)[1]; __match_result = f; } else { __match_result = ""; } __match_result; });
        if ((strcmp(f, "message") == 0)) {
            return haki_string_concat(haki_string_concat("haki_error_message(", cemit__emitExpr(recv, depth, sc, sym)), ")");
        }
        if ((strcmp(f, "cause") == 0)) {
            return haki_string_concat(haki_string_concat("haki_error_cause(", cemit__emitExpr(recv, depth, sc, sym)), ")");
        }
        if ((strcmp(f, "length") == 0)) {
            return haki_string_concat(haki_string_concat("haki_array_length(", cemit__emitExpr(recv, depth, sc, sym)), ")");
        }
        return haki_string_concat(haki_string_concat(cemit__emitExpr(recv, depth, sc, sym), "->"), cemit__cName(f));
    }
    if ((strcmp(tag, "method") == 0)) {
        ...
        const char* re = cemit__emitExpr(recv, depth, sc, sym);
        if (((strcmp(m, "append") == 0) && (haki_array_length(args) == ((int64_t)1LL)))) {
            const char* av = cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym);
        ...
        if ((strcmp(m, "has") == 0)) {
            return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("haki_map_has(", re), ", "), cemit__emitExprList(args, depth, sc, sym)), ")");
        }
        if ((strcmp(m, "get") == 0)) {
            return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("haki_map_get(", re), ", "), cemit__emitExprList(args, depth, sc, sym)), ")");
        }
        if ((strcmp(m, "set") == 0)) {
            return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("haki_map_set(", re), ", "), cemit__emitExprList(args, depth, sc, sym)), ")");
        }
        if ((strcmp(m, "substring") == 0)) {
            return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("haki_string_substring(", re), ", "), cemit__emitExprList(args, depth, sc, sym)), ")");
        }
        if ((strcmp(m, "contains") == 0)) {
            return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("haki_string_contains(", re), ", "), cemit__emitExprList(args, depth, sc, sym)), ")");
        }
        if ((strcmp(m, "split") == 0)) {
            return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("haki_string_split(", re), ", "), cemit__emitExprList(args, depth, sc, sym)), ")");
        }
        if ((strcmp(m, "toUpper") == 0)) {
        ...
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(re, "->"), cemit__cName(m)), "("), re), argStr), ")");
    }
    if ((strcmp(tag, "index") == 0)) {
        ...
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("(*((void**)haki_array_get(", cemit__emitExpr(arr, depth, sc, sym)), ", "), cemit__emitExpr(idx, depth, sc, sym)), ")))");
    }
    if ((strcmp(tag, "array") == 0)) {
    ...
    if ((strcmp(tag, "if") == 0)) {
        ...
        const char* ce = cemit__emitExpr(cond, depth, sc, sym);
        const char* tv = cemit__yieldVal(then, depth, sc, sym);
        const char* ev = cemit__yieldVal(els, depth, sc, sym);
    ...
    if ((strcmp(tag, "match") == 0)) {
        ...
        void* arms = ({ void* __match_result;  void* __msc = (void*)e;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 13LL) { compiler__Expr* s = *(compiler__Expr**)((void**)__mpayload)[0]; void* arms = *(void**)((void**)__mpayload)[1]; __match_result = arms; } else { __match_result = compiler__emptyArms(); } __match_result; });
        return cemit__emitMatchExpr(scrut, arms, depth, sc, sym);
    }
    if ((strcmp(tag, "block") == 0)) {
        void* stmts = ({ void* __match_result;  void* __msc = (void*)e;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 14LL) { void* stmts = *(void**)__mpayload; __match_result = stmts; } else { __match_result = compiler__emptyStmts(); } __match_result; });
        const char* yv = cemit__yieldVal(stmts, depth, sc, sym);
    ...
    if ((strcmp(tag, "async") == 0)) {
        ...
        return haki_string_concat(haki_string_concat("haki_task_spawn_simple((void(*)(void*))", cemit__emitExpr(inner, depth, sc, sym)), ", NULL)");
    }
    return "/* unknown expr */";
}
...
const char* cemit__emitExprList(void* args, int64_t depth, tinfer__Scope* sc, typeck__SymTable* sym) {
    ...
    while ((i < haki_array_length(args))) {
        ...
        (s = haki_string_concat(s, cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, i)), depth, sc, sym)));
        (i = (i + ((int64_t)1LL)));
    }
    return s;
}
...
const char* cemit__yieldVal(void* stmts, int64_t depth, tinfer__Scope* sc, typeck__SymTable* sym) {
    { void* __arr_stmt = stmts;
        ...
        for (int64_t __i_stmt = 0; __i_stmt < __len_stmt; __i_stmt++) {
            ...
            if ((strcmp(tag, "yield") == 0)) {
                compiler__Expr* e = ({ compiler__Expr* __match_result;  void* __msc = (void*)stmt;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 2LL) { compiler__Expr* e = *(compiler__Expr**)__mpayload; __match_result = e; } else { __match_result = compiler__nullExpr(); } __match_result; });
                return cemit__emitExpr(e, depth, sc, sym);
            }
        }
    }
    return "";
...
const char* cemit__emitMatchExpr(compiler__Expr* scrut, void* arms, int64_t depth, tinfer__Scope* sc, typeck__SymTable* sym) {
    const char* se = cemit__emitExpr(scrut, depth, sc, sym);
    ...
    while ((i < haki_array_length(arms))) {
        ...
        while ((bi < haki_array_length(arm->bindings))) {
            (parts = haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(parts, "void* "), cemit__cName((*(const char**)haki_array_get(arm->bindings, bi)))), " = ((void**)__mpayload)["), haki_int_to_string(bi)), "]; "));
            (bi = (bi + ((int64_t)1LL)));
        }
        const char* yv = cemit__yieldVal(arm->body, depth, sc, sym);
        if ((haki_string_length(yv) > ((int64_t)0LL))) {
...
const char* cemit__emitCall(const char* name, void* args, int64_t depth, tinfer__Scope* sc, typeck__SymTable* sym) {
    if (((strcmp(name, "print") == 0) && (haki_array_length(args) == ((int64_t)1LL)))) {
        return haki_string_concat(haki_string_concat("haki_print(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if (((strcmp(name, "print_int") == 0) && (haki_array_length(args) == ((int64_t)1LL)))) {
        return haki_string_concat(haki_string_concat("haki_print_int(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if (((strcmp(name, "print_bool") == 0) && (haki_array_length(args) == ((int64_t)1LL)))) {
        return haki_string_concat(haki_string_concat("haki_print_bool(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if (((strcmp(name, "print_float") == 0) && (haki_array_length(args) == ((int64_t)1LL)))) {
        return haki_string_concat(haki_string_concat("haki_print_float(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if (((strcmp(name, "int_to_string") == 0) && (haki_array_length(args) == ((int64_t)1LL)))) {
        return haki_string_concat(haki_string_concat("haki_int_to_string(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if (((strcmp(name, "string_length") == 0) && (haki_array_length(args) == ((int64_t)1LL)))) {
        return haki_string_concat(haki_string_concat("haki_string_length(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if ((strcmp(name, "panic") == 0)) {
        return haki_string_concat(haki_string_concat("haki_panic(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if ((strcmp(name, "argv") == 0)) {
        return "haki_argv()";
    }
    if ((strcmp(name, "readFile") == 0)) {
        return haki_string_concat(haki_string_concat("haki_read_file(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if ((strcmp(name, "fileExists") == 0)) {
        return haki_string_concat(haki_string_concat("haki_file_exists(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if ((strcmp(name, "Error") == 0)) {
        if ((haki_array_length(args) == ((int64_t)1LL))) {
            return haki_string_concat(haki_string_concat("haki_error_new(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
        }
    }
    if ((haki_string_contains(name, "__append") && (haki_array_length(args) == ((int64_t)2LL)))) {
        const char* av = cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)1LL))), depth, sc, sym);
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("({ void* __el = (void*)(", av), "); haki_array_append("), cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ", &__el); })");
    }
    if ((haki_string_contains(name, "__length") && (haki_array_length(args) == ((int64_t)1LL)))) {
        return haki_string_concat(haki_string_concat("haki_array_length(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ")");
    }
    if ((haki_string_contains(name, "__has") && (haki_array_length(args) == ((int64_t)2LL)))) {
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("haki_map_has(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ", "), cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)1LL))), depth, sc, sym)), ")");
    }
    if ((haki_string_contains(name, "__set") && (haki_array_length(args) == ((int64_t)3LL)))) {
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("haki_map_set(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ", "), cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)1LL))), depth, sc, sym)), ", "), cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)2LL))), depth, sc, sym)), ")");
    }
    if ((haki_string_contains(name, "__getOrDefault") && (haki_array_length(args) == ((int64_t)3LL)))) {
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("haki_map_get_or_default(", cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)0LL))), depth, sc, sym)), ", "), cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)1LL))), depth, sc, sym)), ", "), cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, ((int64_t)2LL))), depth, sc, sym)), ")");
    }
    const char* argStr = "";
    int64_t i = ((int64_t)0LL);
    while ((i < haki_array_length(args))) {
        ...
        (argStr = haki_string_concat(argStr, cemit__emitExpr((*(compiler__Expr**)haki_array_get(args, i)), depth, sc, sym)));
        (i = (i + ((int64_t)1LL)));
    }
    return haki_string_concat(haki_string_concat(haki_string_concat(cemit__cName(name), "("), argStr), ")");
}

const char* cemit__emitStmt(compiler__Stmt* stmt, int64_t depth, tinfer__Scope* sc, typeck__SymTable* sym) {
    const char* ind = cemit__indent(depth);
    ...
    if ((strcmp(tag, "let") == 0)) {
        ...
        const char* name = ({ const char* __match_result;  void* __msc = (void*)stmt;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 0LL) { int8_t isMut = *(int8_t*)((void**)__mpayload)[0]; const char* name = *(const char**)((void**)__mpayload)[1]; compiler__Expr* init = *(compiler__Expr**)((void**)__mpayload)[2]; __match_result = name; } else { __match_result = ""; } __match_result; });
        compiler__Expr* init = ({ compiler__Expr* __match_result;  void* __msc = (void*)stmt;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 0LL) { int8_t isMut = *(int8_t*)((void**)__mpayload)[0]; const char* name = *(const char**)((void**)__mpayload)[1]; compiler__Expr* init = *(compiler__Expr**)((void**)__mpayload)[2]; __match_result = init; } else { __match_result = compiler__nullExpr(); } __match_result; });
        return cemit__emitLet(name, init, depth, sc, sym);
    }
    if ((strcmp(tag, "return") == 0)) {
        ...
        if ((haki_array_length(vals) == ((int64_t)1LL))) {
            return haki_string_concat(haki_string_concat(haki_string_concat(ind, "return "), cemit__emitExpr((*(compiler__Expr**)haki_array_get(vals, ((int64_t)0LL))), depth, sc, sym)), ";\n");
        }
        ...
        while ((i < haki_array_length(vals))) {
            const char* ve = cemit__emitExpr((*(compiler__Expr**)haki_array_get(vals, i)), depth, sc, sym);
            const char* si = haki_int_to_string(i);
            if (cemit__isScalarTy("int")) {
    ...
    if ((strcmp(tag, "expr") == 0)) {
        compiler__Expr* e = ({ compiler__Expr* __match_result;  void* __msc = (void*)stmt;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 6LL) { compiler__Expr* e = *(compiler__Expr**)__mpayload; __match_result = e; } else { __match_result = compiler__nullExpr(); } __match_result; });
        const char* es = cemit__emitExpr(e, depth, sc, sym);
    ...
    if ((strcmp(tag, "assign") == 0)) {
        ...
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(ind, cemit__emitExpr(target, depth, sc, sym)), " = "), cemit__emitExpr(val, depth, sc, sym)), ";\n");
    }
    if ((strcmp(tag, "if") == 0)) {
        ...
        const char* s = haki_string_concat(haki_string_concat(haki_string_concat(ind, "if ("), cemit__emitExpr(cond, depth, sc, sym)), ") {\n");
        { void* __arr_st = then;
            ...
            for (int64_t __i_st = 0; __i_st < __len_st; __i_st++) {
                ...
                (s = haki_string_concat(s, cemit__emitStmt(st, (depth + ((int64_t)1LL)), sc, sym)));
            }
        }
    ...
    if ((strcmp(tag, "while") == 0)) {
        ...
        const char* s = haki_string_concat(haki_string_concat(haki_string_concat(ind, "while ("), cemit__emitExpr(cond, depth, sc, sym)), ") {\n");
        { void* __arr_st = body;
            int64_t __len_st = haki_array_length(__arr_st);
            for (int64_t __i_st = 0; __i_st < __len_st; __i_st++) {
                compiler__Stmt* st = *(compiler__Stmt**)haki_array_get(__arr_st, __i_st);
    ...
    if ((strcmp(tag, "for") == 0)) {
        ...
        void* body = ({ void* __match_result;  void* __msc = (void*)stmt;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 9LL) { const char* v = *(const char**)((void**)__mpayload)[0]; compiler__Expr* iter = *(compiler__Expr**)((void**)__mpayload)[1]; void* body = *(void**)((void**)__mpayload)[2]; __match_result = body; } else { __match_result = compiler__emptyStmts(); } __match_result; });
        const char* arrVar = haki_string_concat("__arr_", cemit__cName(varName));
        const char* idxVar = haki_string_concat("__i_", cemit__cName(varName));
        const char* s = haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(ind, "{ void* "), arrVar), " = "), cemit__emitExpr(iter, depth, sc, sym)), ";\n");
        ...
        (s = haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(s, cemit__indent((depth + ((int64_t)2LL)))), "void* "), cemit__cName(varName)), " = *(void**)haki_array_get("), arrVar), ", "), idxVar), ");\n"));
        { void* __arr_st = body;
            int64_t __len_st = haki_array_length(__arr_st);
            for (int64_t __i_st = 0; __i_st < __len_st; __i_st++) {
                compiler__Stmt* st = *(compiler__Stmt**)haki_array_get(__arr_st, __i_st);
                (s = haki_string_concat(s, cemit__emitStmt(st, (depth + ((int64_t)2LL)), sc, sym)));
            }
        }
        (s = haki_string_concat(haki_string_concat(s, ind), "  }\n"));
        (s = haki_string_concat(haki_string_concat(s, ind), "}\n"));
...
const char* cemit__emitLet(const char* name, compiler__Expr* init, int64_t depth, tinfer__Scope* sc, typeck__SymTable* sym) {
    const char* ind = cemit__indent(depth);
    const char* nm = cemit__cName(name);
    if ((strcmp(nm, "_") == 0)) {
        return haki_string_concat(haki_string_concat(haki_string_concat(ind, "(void)("), cemit__emitExpr(init, depth, sc, sym)), ");\n");
    }
    ...
    if (isArr) {
        ...
        { void* __arr_el = elems;
            ...
            for (int64_t __i_el = 0; __i_el < __len_el; __i_el++) {
                ...
                const char* ev = cemit__emitExpr(el, depth, sc, sym);
    ...
    if (isCall) {
        ...
        if (((strcmp(callName, "Error") == 0) && (haki_array_length(callArgs) == ((int64_t)1LL)))) {
            return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(ind, "void* "), nm), " = haki_error_new("), cemit__emitExpr((*(compiler__Expr**)haki_array_get(callArgs, ((int64_t)0LL))), depth, sc, sym)), ");\n");
        }
    }
    const char* initStr = cemit__emitExpr(init, depth, sc, sym);
    const char* inferredTy = tinfer__inferWithScope(init, sc, sym);
    const char* ctype = cemit__cTy(inferredTy);
    tinfer__scopeSet(sc, name, inferredTy);
    if ((strcmp(ctype, "int64_t") == 0)) {
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(ind, "int64_t "), nm), " = "), initStr), ";\n");
    }
    if ((strcmp(ctype, "double") == 0)) {
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(ind, "double "), nm), " = "), initStr), ";\n");
    }
    if ((strcmp(ctype, "int8_t") == 0)) {
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(ind, "int8_t "), nm), " = "), initStr), ";\n");
    }
    if ((strcmp(ctype, "const char*") == 0)) {
        return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(ind, "const char* "), nm), " = "), initStr), ";\n");
    }
...
const char* cemit__emitFnProto(mono__MonoFn* f) {
    const char* ret = cemit__cRetTy(f->retTy);
    const char* params = "";
    int64_t i = ((int64_t)0LL);
    while ((i < haki_array_length(f->params))) {
        ...
        (params = haki_string_concat(haki_string_concat(haki_string_concat(params, cemit__cTy((*(compiler__Param**)haki_array_get(f->params, i))->ty)), " "), cemit__cName((*(compiler__Param**)haki_array_get(f->params, i))->name)));
        (i = (i + ((int64_t)1LL)));
    }
    ...
    return haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(ret, " "), cemit__cName(f->name)), "("), params), ")");
}

const char* cemit__emitFn(mono__MonoFn* f, typeck__SymTable* sym) {
    compiler__FnDef* fnDef = compiler__makeFnDef(f->name, f->params, f->retTy, f->body);
    tinfer__Scope* sc = tinfer__buildFnScope(fnDef, sym);
    const char* s = haki_string_concat(cemit__emitFnProto(f), " {\n");
    if ((strcmp(f->name, "main") == 0)) {
    ...
    { void* __arr_stmt = f->body;
        ...
        for (int64_t __i_stmt = 0; __i_stmt < __len_stmt; __i_stmt++) {
            compiler__Stmt* stmt = *(compiler__Stmt**)haki_array_get(__arr_stmt, __i_stmt);
            (s = haki_string_concat(s, cemit__emitStmt(stmt, ((int64_t)1LL), sc, sym)));
        }
    }
...
const char* cemit__emitStructDef(compiler__StructDef* s) {
    ...
    const char* out = haki_string_concat(haki_string_concat("struct ", cemit__cName(s->name)), " {\n");
    { void* __arr_f = s->fields;
        int64_t __len_f = haki_array_length(__arr_f);
        for (int64_t __i_f = 0; __i_f < __len_f; __i_f++) {
            compiler__Param* f = *(compiler__Param**)haki_array_get(__arr_f, __i_f);
            (out = haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat(out, "    "), cemit__cTy(f->ty)), " "), cemit__cName(f->name)), ";\n"));
        }
    }
...
const char* cemit__emitProgram(mono__MonoProgram* prog, const char* runtimeSrc) {
    ...
    { void* __arr_f = prog->fns;
        ...
        for (int64_t __i_f = 0; __i_f < __len_f; __i_f++) {
            mono__MonoFn* f = *(mono__MonoFn**)haki_array_get(__arr_f, __i_f);
            (out = haki_string_concat(out, cemit__emitFn(f, sym)));
        }
    }
    return out;
}
...
void* cemit__compileToC(const char* src, const char* runtimeSrc) {
    __Tuple2* __mb_30215 = (__Tuple2*)(mono__monoFromSource(src));
    mono__MonoProgram* prog = (mono__MonoProgram*)__mb_30215->f0;
    void* err = (void*)__mb_30215->f1;
    if ((err != NULL)) {
        __Tuple2* __ret = (__Tuple2*)malloc(sizeof(__Tuple2));
        __ret->f0 = (void*)("");
        __ret->f1 = (void*)(err);
...
void cemit__test_escape_str(void) {
    const char* s = cemit__escapeStr("hello\nworld");
    if ((!(strcmp(s, "hello\\nworld") == 0))) {
...
void cemit__test_emit_proto(void) {
    ...
    const char* proto = cemit__emitFnProto(mf);
...
void cemit__main(void) {
    ...
    __Tuple2* __mb_31595 = (__Tuple2*)(cemit__compileToC(miniSrc, "/* runtime stub */"));
    const char* c = (const char*)__mb_31595->f0;
    void* err = (void*)__mb_31595->f1;
    if ((err != NULL)) {
        haki_print(haki_string_concat("error: ", haki_error_message(err)));
        return;
    }
...
void printUsage(void) {
    haki_print("usage: hakic <source.haki>");
    haki_print("       hakic check <source.haki>");
    haki_print("       hakic <source.haki> --emit-c -o <output>");
}

void doCheck(const char* path) {
    __Tuple2* __mb_669 = (__Tuple2*)(haki_read_file(path));
    const char* src = (const char*)__mb_669->f0;
    void* _readErr = (void*)__mb_669->f1;
    __Tuple2* __mb_710 = (__Tuple2*)(compiler__parse(src));
    void* items = (void*)__mb_710->f0;
    void* _pe1 = (void*)__mb_710->f1;
    __Tuple2* __mb_755 = (__Tuple2*)(typeck__typecheck(src));
    typeck__SymTable* sym = (typeck__SymTable*)__mb_755->f0;
    void* _te1 = (void*)__mb_755->f1;
    haki_print(haki_string_concat("â  ", path));
}
...
int8_t alreadyResolved(void* visited, const char* path) {
    { void* __arr_p = visited;
        int64_t __len_p = haki_array_length(__arr_p);
        for (int64_t __i_p = 0; __i_p < __len_p; __i_p++) {
            const char* p = *(const char**)haki_array_get(__arr_p, __i_p);
            if ((strcmp(p, path) == 0)) {
                return 1;
            }
        }
...
void resolveImports(mono__MonoProgram* dst, void* items, void* visited) {
    ...
    while ((i < haki_array_length(items))) {
        compiler__Item* item = (*(compiler__Item**)haki_array_get(items, i));
        int8_t isImport = ({ int8_t __match_result;  void* __msc = (void*)item;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 2LL) { const char* p = *(const char**)((void**)__mpayload)[0]; const char* a = *(const char**)((void**)__mpayload)[1]; __match_result = 1; } else { __match_result = 0; } __match_result; });
        if (isImport) {
            const char* path = ({ const char* __match_result;  void* __msc = (void*)item;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 2LL) { const char* p = *(const char**)((void**)__mpayload)[0]; const char* a = *(const char**)((void**)__mpayload)[1]; __match_result = p; } else { __match_result = ""; } __match_result; });
            const char* alias = ({ const char* __match_result;  void* __msc = (void*)item;  int64_t __mtag = ((int64_t*)__msc)[0];  void* __mpayload = ((void**)__msc)[1];  if (__mtag == 2LL) { const char* p = *(const char**)((void**)__mpayload)[0]; const char* a = *(const char**)((void**)__mpayload)[1]; __match_result = a; } else { __match_result = ""; } __match_result; });
            if ((!(strcmp(path, "__skip__") == 0))) {
                const char* fullPath = haki_string_concat(path, ".haki");
                if ((!alreadyResolved(visited, fullPath))) {
                    haki_array_append_val(visited, &(fullPath));
                    __Tuple2* __mb_1862 = (__Tuple2*)(haki_read_file(fullPath));
                    const char* modSrc = (const char*)__mb_1862->f0;
                    void* _modErr2 = (void*)__mb_1862->f1;
                    __Tuple2* __mb_1926 = (__Tuple2*)(compiler__parse(modSrc));
                    void* modItems = (void*)__mb_1926->f0;
                    void* _pe2 = (void*)__mb_1926->f1;
                    mono__MonoProgram* modProg = mono__monomorphize(modItems);
...
void doEmitC(const char* srcPath, const char* outPath) {
    __Tuple2* __mb_2286 = (__Tuple2*)(haki_read_file(srcPath));
    const char* src = (const char*)__mb_2286->f0;
    void* _srcErr = (void*)__mb_2286->f1;
    __Tuple2* __mb_2329 = (__Tuple2*)(compiler__parse(src));
    void* items = (void*)__mb_2329->f0;
    void* _pe3 = (void*)__mb_2329->f1;
    __Tuple2* __mb_2374 = (__Tuple2*)(haki_read_file("/home/claude/haki_bootstrap/haki_runtime_core.c"));
    const char* rtSrc = (const char*)__mb_2374->f0;
    void* _rtErr = (void*)__mb_2374->f1;
    mono__MonoProgram* prog = mono__monomorphize(items);
    const char* cSrc = cemit__emitProgram(prog, rtSrc);
    void* _wErr = haki_write_file(outPath, cSrc);
    haki_print(haki_string_concat(haki_string_concat(haki_string_concat(haki_string_concat("[emit-c]  ", outPath), " ("), haki_int_to_string(haki_string_length(cSrc))), " bytes)"));
}
...
int main(int argc, char** argv) {
    ...
    const char* cmd = (*(const char**)haki_array_get(args, ((int64_t)1LL)));
    if ((strcmp(cmd, "check") == 0)) {
        if ((haki_array_length(args) < ((int64_t)3LL))) {
            haki_print("hakic check: missing source file");
            return;
        }
        doCheck((*(const char**)haki_array_get(args, ((int64_t)2LL))));
        return;
    }
    const char* srcPath = "";
    const char* outPath = "";
    ...
    while ((i < haki_array_length(args))) {
        const char* a = (*(const char**)haki_array_get(args, i));
        if ((strcmp(a, "--emit-c") == 0)) {
            ...
            if ((strcmp(a, "-o") == 0)) {
                ...
                if ((i < haki_array_length(args))) {
                    (outPath = (*(const char**)haki_array_get(args, i)));
                }
            }
            else {
                if ((!(strcmp(a, "--quiet") == 0))) {
    ...
    __Tuple2* __mb_3843 = (__Tuple2*)(haki_read_file(srcPath));
    const char* src = (const char*)__mb_3843->f0;
    void* _mainErr = (void*)__mb_3843->f1;
    haki_print("[lex+parse]");
    __Tuple2* __mb_3912 = (__Tuple2*)(compiler__parse(src));
    void* items = (void*)__mb_3912->f0;
    void* _pe4 = (void*)__mb_3912->f1;
    haki_print("[typecheck]");
    __Tuple2* __mb_3982 = (__Tuple2*)(typeck__typecheck(src));
    typeck__SymTable* sym = (typeck__SymTable*)__mb_3982->f0;
    void* _te4 = (void*)__mb_3982->f1;
    haki_print("");
    haki_print("â  ok");
    return 0;
}
